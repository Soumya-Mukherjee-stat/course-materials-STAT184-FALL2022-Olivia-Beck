...
- Final Project: Monday, December 12th at 11:59 p.m.
  - Final Report
  - Final Checklist
  - Remember to push to GitHub! 
  
- All late work due Friday, December 9th at 11:59 p.m.
...
If I want to load in the Harry Potter Characters list (located in the week-15 folers) I can .... 


1. Reference the exact location on my computer 

```{r}
path.absolute <- "/Users/oliviabeck/Dropbox/Olivia/Conflict/school/STAT184/course-materials/class-notes/week-15/Characters.csv"
...
```{r, eval = F, message=F}
path.relative <- "class-notes/week-15/Characters.csv"
...
```{r, message=F}
harry.potter <- read_delim("class-notes/week-15/Characters.csv", 
    delim = ";", escape_double = FALSE, trim_ws = TRUE)
