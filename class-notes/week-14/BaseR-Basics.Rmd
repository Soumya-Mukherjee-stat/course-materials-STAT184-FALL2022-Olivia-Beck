...
- SRTE's available 
- Activity: Base R due December 7th 

- Final Project Peer Review (Optional but highly recommened)
  - December 1, 2022 @ 11:59pm: Submit draft of Final Project Report for peer review
...
- Final Project Due Dates 
  - December 12, 2022 @ 11:59pm: Final Project Report + Checklist Due
  - December 12, 2022 @ 11:59pm: Peer Evaluation of Project Contributions

- All late work due December 9th at 11:59 p.m. 
...
#### Select elements in the set {f, g, h}
```{r, echo=TRUE}
y[y %in% c("E", "F", "G")]
```
